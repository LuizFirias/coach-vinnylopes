-- ============================================================
-- AURONFIT · Setup completo do banco
-- Cole TUDO no SQL Editor do auronfit-prod e clique em Run.
-- Conteudo: 0) reset  1) extensao  2) schema completo  3) fixes
-- SEGURO RE-RODAR: zera o schema public antes de recriar tudo.
-- ============================================================

-- 0) Reset: limpa o schema public (deixa o banco pronto p/ recriar)
DROP SCHEMA IF EXISTS public CASCADE;
CREATE SCHEMA public;
GRANT USAGE ON SCHEMA public TO anon, authenticated, service_role;
GRANT ALL   ON SCHEMA public TO postgres, anon, authenticated, service_role;

-- 1) Extensao usada pelos defaults de algumas tabelas
