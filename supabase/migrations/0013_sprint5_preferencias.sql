...
-- ============================================================
-- Adiciona colunas de preferências e configurações pessoais
-- na tabela profiles para suportar personalização do app.
--
-- Referência: MIGRATION-PLAN.md §9
-- Rollback: ver final do arquivo
-- ============================================================

-- Bloco J — Adicionar colunas em profiles
...
-- ============================================================
-- ROLLBACK (rodar em caso de necessidade de reverter)
-- ============================================================
/*
ALTER TABLE profiles
