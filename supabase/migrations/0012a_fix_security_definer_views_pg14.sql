-- Fix: Remover SECURITY DEFINER desnecessário (PostgreSQL < 15 compatible)
-- Se a migration 0012 falhar com "syntax error near WITH", use este arquivo
-- Problema: Supabase Security Advisor reporta views como tendo SECURITY DEFINER
-- Solução: Remover SECURITY DEFINER de get_kpis_aluno + recriar views
...
-- ============================================================
-- 3. Recriar v_historico_validos (SECURITY INVOKER é default)
-- ============================================================

CREATE VIEW public.v_historico_validos AS
SELECT h.*
FROM historico_treinos h
WHERE EXISTS (
  SELECT 1
...
-- ============================================================
-- 4. Recriar v_streak_aluno (SECURITY INVOKER é default)
-- ============================================================
...
-- ============================================================
-- 5. Recriar v_leaderboard (SECURITY INVOKER é default)
-- ============================================================
...
-- ============================================================
-- 6. Recriar v_atletas_ativos_semana (SECURITY INVOKER é default)
-- ============================================================

CREATE VIEW public.v_atletas_ativos_semana AS
...
-- 2. All 4 views: Explicitly use public schema references (no WITH syntax needed)
-- 3. All views default to SECURITY INVOKER (respects caller's RLS)
--
-- This version is compatible with PostgreSQL < 15
-- If you get "syntax error near WITH", use this file instead of 0012
