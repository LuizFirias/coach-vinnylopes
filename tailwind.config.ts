  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-brand': '0 0 24px rgba(147, 51, 234, 0.22)',
        'glow-success': '0 0 24px rgba(57, 199, 90, 0.24)',
        'pr-glow': '0 0 20px rgba(57, 199, 90, 0.32)',
        'focus-ring': '0 0 0 2px rgba(147, 51, 234, 0.50)',
        'btn-glow': '0 4px 20px rgba(147, 51, 234, 0.45)',
        'btn-glow-hover': '0 6px 28px rgba(147, 51, 234, 0.60)',
      },
      backgroundImage: {
        'btn-primary': 'linear-gradient(135deg, #c084fc 0%, #9333ea 55%, #7e22ce 100%)',
      },
