...
export const metadata: Metadata = {
  title: "Política de Privacidade | Coach Vinny",
  description: "Política de Privacidade da plataforma Coach Vinny (LGPD).",
};
  ...
  return (
    ...
    >
      <Section title="1. Quem somos">
        <p>
          Esta Política descreve como o Coach Vinny trata dados pessoais de coaches
      ...
      <Section title="10. Contato do encarregado">
        <p>
          ...
          <a href="mailto:privacidade@vinnylopescoach.site">
            privacidade@vinnylopescoach.site
          </a>{" "}
          ou{" "}
