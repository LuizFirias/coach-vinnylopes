      ...
      <section className="relative min-h-screen pt-[72px] flex items-center bg-gradient-to-b from-surface-1 via-surface-1 to-surface-0 overflow-hidden">
        ...
        <div className="w-full max-w-7xl mx-auto px-6 md:px-12 py-12 md:py-24 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative flex justify-center items-center h-[420px] sm:h-[480px] lg:h-[620px] w-full select-none">
            ...
            {/* Mockup Container Student (Right rotated, overlapping) - Centered on mobile */}
            <div className="absolute left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0 sm:right-[15%] lg:right-[8%] top-[5%] sm:top-[15%] transform rotate-0 sm:rotate-[6deg] hover:rotate-0 hover:scale-102 hover:z-20 transition-all duration-500 z-10">
              <div className="w-[200px] sm:w-[270px] h-[400px] sm:h-[540px] border-[8px] sm:border-[10px] border-zinc-800 bg-zinc-950 rounded-[30px] sm:rounded-[36px] shadow-2xl relative flex flex-col justify-center items-center text-center p-4">
                ...
                <div className="flex-1 w-full h-full flex flex-col justify-center items-center text-[#71717A] px-2">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#10B981]/10 border border-[#10B981]/30 flex items-center justify-center mb-3">
                    <Barbell className="w-4 h-4 sm:w-5 sm:h-5 text-[#10B981]" />
                  </div>
                  <span className="text-[9px] sm:text-[10px] font-bold tracking-widest text-[#10B981] uppercase mb-1">App do Aluno</span>
                  <p className="text-[8px] sm:text-[9px] text-[#52525B] leading-relaxed max-w-[140px] sm:max-w-[160px]">
                    Área do Mockup Aluno. As imagens do aplicativo móvel serão inseridas manualmente aqui.
                  </p>
                </div>
                {/* Home indicator */}
                <div className="absolute bottom-1.5 left-1/2 -translate-x-1/2 w-20 sm:w-24 h-1 bg-zinc-800 rounded-full" />
              </div>
            </div>
          ...
          <div className="pt-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-4xl mx-auto items-center text-left">
              ...
              <div className="flex justify-center">
                <div className="w-[200px] sm:w-[260px] h-[400px] sm:h-[520px] border-[8px] sm:border-[10px] border-zinc-800 bg-zinc-950 rounded-[30px] sm:rounded-[36px] shadow-2xl relative flex flex-col justify-center items-center text-center p-4">
                  {/* Speaker pill */}
                  <div className="absolute top-2.5 left-1/2 -translate-x-1/2 w-16 sm:w-20 h-3 sm:h-3.5 bg-zinc-800 rounded-full" />
                  {/* Mockup area */}
                  <div className="flex-1 w-full h-full flex flex-col justify-center items-center text-[#71717A] px-2">
                    ...
                    <span className="text-[9px] sm:text-[10px] font-bold tracking-widest text-[#10B981] uppercase mb-1">Mockup Smartphone</span>
                    <p className="text-[8px] sm:text-[9px] text-[#52525B] leading-relaxed max-w-[140px] sm:max-w-[150px]">
