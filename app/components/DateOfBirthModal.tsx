        ...
        <form onSubmit={handleUpdateDate} className="px-6 py-5 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              disabled={loading}
              required
              className="w-full min-w-0 h-12 bg-surface-0 border border-input text-text-primary px-4 rounded-xl text-base focus:outline-none focus:border-brand/40 transition-colors [color-scheme:dark]"
            />
          </div>
