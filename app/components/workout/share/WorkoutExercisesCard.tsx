  ...
  return (
    <ShareCardShell theme={theme}>
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'row', gap: 40, marginBottom: 28 }}>
          <StatItem label="Duração" value={durationFormatted} theme={theme} labelSize={22} valueSize={42} />
          <StatItem label="Volume" value={formatShareVolume(volumeKg)} accent theme={theme} labelSize={22} valueSize={42} />
          <StatItem label="Séries" value={String(totalSets)} theme={theme} labelSize={22} valueSize={42} />
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20, flex: 1 }}>
          ...
          {remaining > 0 && (
            <p style={{ fontSize: 26, color: tokens.textSecondary, marginTop: 12, marginBottom: 0 }}>
