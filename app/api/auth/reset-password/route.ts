...
export async function POST(req: Request) {
  try {
    ...
    const siteUrl = origin || process.env.NEXT_PUBLIC_SITE_URL || "https://vinnylopescoach.site";
    ...
    if (resetLink && hasResend) {
      try {
        ...
        let emailHtml = "";
        let emailSubject = "Redefinição de senha — Coach Vinny";
        ...
        if (role === "coach" || role === "super_admin") {
          ...
          emailSubject = "Recuperação de Acesso - Coach Vinny";
        }
