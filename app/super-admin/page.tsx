      ...
      <div className="max-w-3xl mx-auto">
        <header className="mb-12 text-center">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#0F0F0F] rounded-full shadow-2xl mb-8 border border-[#1a1a1a]">
              ...
              <span className="text-[10px] uppercase tracking-[0.4em] text-zinc-500">Controle Executivo</span>
            </div>
            <h1 className="text-5xl text-white tracking-tighter mb-3 uppercase">GERENCIAR <span className="text-[#D4AF37]">ACESSOS</span></h1>
            <p className="text-zinc-600 text-[10px] uppercase tracking-widest">Controle de permissões e expansão da plataforma premium</p>
        </header>
        ...
        <div className="bg-[#0F0F0F] rounded-3xl p-10 lg:p-16 relative overflow-hidden shadow-2xl border border-[#1a1a1a]">
          <div className="relative">
            <div className="mb-14 flex flex-col items-center sm:items-start">
              ...
              <h2 className="text-3xl text-white mb-2 uppercase tracking-tight">Novo Professor</h2>
              <p className="text-[10px] text-zinc-600 uppercase tracking-widest leading-loose">Promova alunos existentes ou conceda credenciais de Coach</p>
            </div>
            
            <form onSubmit={handlePromote} className="space-y-10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="md:col-span-2 space-y-3">
                  <label className="block text-[10px] uppercase tracking-[0.3em] text-zinc-700 ml-1">
              ...
              {message && (
                <div className={`p-8 rounded-2xl text-[10px] uppercase tracking-widest animate-in fade-in slide-in-from-bottom-4 flex items-center gap-5 ${
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-6 bg-[#D4AF37] text-black text-[11px] uppercase tracking-[0.4em] rounded-2xl shadow-xl hover:bg-white active:scale-[0.98] transition-all duration-300 disabled:opacity-50 flex items-center justify-center gap-4"
              >
                {loading ? (
        ...
        <footer className="mt-20 text-center space-y-8">
            <p className="text-zinc-700 text-[10px] uppercase tracking-[0.3em] max-w-sm mx-auto leading-loose">
