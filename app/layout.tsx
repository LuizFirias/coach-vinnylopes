...
(function() {
  try {
    ...
    if (localStorage.getItem('coach-vinny-theme-v2-light') !== '1') {
      localStorage.setItem('coach-vinny-theme', 'light');
      localStorage.setItem('coach-vinny-theme-v2-light', '1');
    }
    ...
    var theme = (!isDesktop && localStorage.getItem('coach-vinny-theme') === 'dark') ? 'dark' : 'light';
