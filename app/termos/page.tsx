...
export const metadata: Metadata = {
  title: "Termos de Uso | Coach Vinny",
  description: "Termos de Uso da plataforma Coach Vinny.",
};
  ...
  return (
    <LegalPageShell title="Termos de Uso" updatedAt="11 de agosto de 2026">
      <Section title="1. Aceitação">
        <p>
          Ao criar uma conta ou utilizar a plataforma Coach Vinny ("nós"),
      ...
      <Section title="2. O serviço">
        <p>
          O Coach Vinny é uma plataforma de gestão de treinos e acompanhamento para
      ...
      <Section title="5. Conteúdo do usuário">
        <p>
          ...
          fotos, mensagens). Ao usar o Coach Vinny, concede-nos licença limitada
      ...
      <Section title="6. Isenções importantes">
        <p>
          O Coach Vinny é uma ferramenta de gestão e não substitui acompanhamento
      ...
      <Section title="10. Contato">
        <p>
          ...
          <a href="mailto:suporte@vinnylopescoach.site">suporte@vinnylopescoach.site</a>.
        </p>
      </Section>
    </LegalPageShell>
  );
